...
public class UserBean implements Serializable{
	...
	public String ajouter(){
		...
		try {
			...
			FacesMessage message = new FacesMessage(FacesMessage.SEVERITY_INFO, "Enregistrement de user",bodymsg );
	...
	public void edit(){	
		...
		FacesMessage message = new FacesMessage(FacesMessage.SEVERITY_INFO, "Modification de user",bodymsg );
		RequestContext.getCurrentInstance().showMessageInDialog(message);
	}
